...
main:
	...
	ldr r1, =-5			@ r1 contiene il contatore
	
loop:					@ inizio del loop
	@@@ Corpo centrale del loop
	mul r2, r1, r1		@ r2 contiene il quadrato r1^2
	add r0, r0, r2		@ aggiungo il quadrato alla somma parziale
	...
	ble loop			@ torno indietro se r1<=r3; condition code per interi con segno
